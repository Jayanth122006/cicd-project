...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // TODO: Save the JWT token you will add later
      navigate("/"); // Redirect to home page on success

    } catch (error) {
      console.error("Login failed:", error);
      const errorMessage = error.response ? error.response.data : "Login failed! The server is not responding.";
      alert(errorMessage);
    }
  };
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="forgot-password">
              <Link to="/auth/user/forgot-password" className="link">
                Forgot Password?
              </Link>
            </div>
